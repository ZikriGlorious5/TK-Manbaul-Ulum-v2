...
function KegiatanForm({ kegiatan }) {
        ...
        <div className="max-w-[600px]">
            ...
            >
                ...
                <div className="flex flex-col gap-1.5">
                    ...
                    {isEdit && kegiatan.foto_url && (
                        <img
                            src={kegiatan.foto_url}
                            alt=""
...
KegiatanForm.layout = (page) => <AdminLayout>{page}</AdminLayout>;
